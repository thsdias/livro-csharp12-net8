...
PrintTitle("Working with big integers");
...
PrintTitle("Working with complex numbers");
...
PrintTitle("Generating random numbers");

Random r = new();

// Specifies a seed value used to initialize its pseudo-random number generator.
Random r2 = new(Seed: 46378);
