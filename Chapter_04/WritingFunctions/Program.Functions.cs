...
partial class Program
{
    ...
    {
        /*
            Esta função habilita a codificação UTF-8 para a saída do console. 
            Isto é necessário para gerar alguns símbolos especiais, como o símbolo da moeda Euro. 
            Esta função também controla a cultura atual usada para formatar datas, horas e valores monetários.
        */
    ...
    static string CardinalToOrdinal(uint number)
    {
        ...
        switch (lastTwoDigits)
        {
            ...
            case 12:
            case 13:
                return $"{number:N0}th";    // Special cases for 11th to 13th.
            default:
    ...
    static int Factorial(int number)
    {
        if(number < 0)
        {
            throw new ArgumentOutOfRangeException(message: $"The factorial function is defined for non-negative integers only. Input: {number}",
